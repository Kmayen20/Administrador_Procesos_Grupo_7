...
namespace Administrador_Procesos
{
    ...
    {   //Kevin 
        ...
        private void ActualizarTabla()
        {
            ...
            dgv_Proceso.Columns[2].Name = "CPU";
            ...
            foreach (Process p_proc in Process.GetProcesses())
            {
                //Ingreso de los datos en el datagrid
                dgv_Proceso.Rows.Add(c_proc, p_proc.ProcessName, p_proc.SessionId, p_proc.Id, p_proc.WorkingSet64,
                    p_proc.VirtualMemorySize64);
                //aumento en 1 de la variable
                c_proc += 1;
            }
            //El label muestra la cantidad de procesos actuales
            lbl_Contador.Text = "Procesos Actuales: " + (c_proc - 1);    //  cant de procesos   


        } //fin metodo ActualizarTabla


        //Boton Actualizar Edgar G
...
//Base obtenida de github.com/man88GG/SO_1